...
# При изменении данного файла не забывать синхронизировать его с этим же файлом в ветке for_experiments! Также данный файл можно
# запускать на роботе Инженер
