...
WINDOW_YOLOV4_TINY = "yolov4-tiny"
FREQ = 30
...
# если запускать на Инженере (иначе - закомментить)
config_path = "/home/lirs/ruslan/kpfu/magistracy/ml_models/yolov4-tiny/cfg/yolov4-tiny.cfg"
weights_path = "/home/lirs/ruslan/kpfu/magistracy/ml_models/yolov4-tiny/weights/yolov4-tiny.weights"
# если запускать на своем ноутбуке (иначе - закомментить)
# config_path = "/home/ruslan/kpfu/magistracy/ml_models/yolov4-tiny/cfg/yolov4-tiny.cfg"
# weights_path = "/home/ruslan/kpfu/magistracy/ml_models/yolov4-tiny/weights/yolov4-tiny.weights"

font_scale = 1
thickness = 2
# если запускать на Инженере (иначе - закомментить)
labels = open("/home/lirs/ruslan/kpfu/magistracy/ml_models/yolov4-tiny/data/coco.names").read().strip().split("\n")
# если запускать на своем ноутбуке (иначе - закомментить)
# labels = open("/home/ruslan/kpfu/magistracy/ml_models/yolov4-tiny/data/coco.names").read().strip().split("\n")
...
def img_callback(msg: Image, cv_bridge: CvBridge, img_publisher: rospy.Publisher) -> None:
	...
	if img_callback_count == 0:
		...
		# просто для показа
		cv2.imshow(WINDOW_YOLOV4_TINY, img_rgb)
		cv2.waitKey(1)
